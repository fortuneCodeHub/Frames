...
{ 
    ...
    public function help()
    {
        echo "
            ...
            Frames v$this->version Command Line Tool
    ...
    public function make($argv):mixed
    {
        ...
        switch ($mode) {
            case 'make:controller':
                ...
                $sample_file = file_get_contents("app".DS."frames".DS."samples".DS."controller-sample.php"); 
            ...
            case 'make:model':
                ...
                $sample_file = file_get_contents("app".DS."frames".DS."samples".DS."model-sample.php"); 
            ...
            case 'make:migration':
                ...
                $sample_file = file_get_contents("app".DS."frames".DS."samples".DS."migration-sample.php"); 
        ...
        switch ($mode) {
            case 'db:create':
                ...
                if (empty($files)) {
                    ...
                    echo "\n\r A Database already exists for this project \n\r";
                    echo "\n\r To change the current DB, go to app >> DB_Folder >> DB_Handler.php \n\r";
                }
